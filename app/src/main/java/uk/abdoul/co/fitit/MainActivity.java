...
import uk.abdoul.co.fitit.calendar.CalendarViewActivity;
import uk.abdoul.co.fitit.firebase.LoginActivity;
import uk.abdoul.co.fitit.firebase.Main;
import uk.abdoul.co.fitit.fragment.LibraryFragment;
import uk.abdoul.co.fitit.fragment.Workout_fragment;
...
//            share_online =(Button)MyDialog.findViewById(R.id.share_online);
           ...
           /* share_online.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    share.putExtra(Intent.EXTRA_TEXT,"http://abdoul.com.ng/product/mobileDev/load.php?app_id=19&name=ibulksms-mobile-app");
