...
public class SignUp_Fragment extends Fragment  implements View.OnClickListener {
    ...
    private static EditText fullName, emailId, username,
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.already_user:
                ...
                new HomeActivity().replaceLoginFragment();
                break;
        }
    ...
    private void checkValidation() {
        ...
        if (getFullName.equals("") || getFullName.length() == 0
            ...
            //UserRegisterFunction(getFullName,getUsername,getEmailId,getPassword);
        }
    }
}
