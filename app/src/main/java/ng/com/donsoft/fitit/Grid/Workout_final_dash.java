...
public class Workout_final_dash extends Activity {
    ...
    public void PasteData() {
        ...
        if (getIntent().getStringExtra("txttitle").contains("Barbell Bench Press")) {
        ...
        if (getIntent().getStringExtra("txttitle").contains("Dip")) {
